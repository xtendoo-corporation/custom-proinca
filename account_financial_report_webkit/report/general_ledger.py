...
class GeneralLedgerWebkit(report_sxw.rml_parse, CommonReportHeaderWebkit):
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        acumulado_fecha = self._get_form_param('acumulado_fecha', data, default=False)
        ...
        if acumulado_fecha:
            if fiscalyear:
                start_period = self.get_first_fiscalyear_period(fiscalyear)
                stop_period = self.get_last_fiscalyear_period(fiscalyear)
                main_filter = "filter_no"
                start = start_period
                stop = stop_period
            else:
                start_period = stop_period = False
        ...
        self.localcontext.update({
            ...
            'acumulado_fecha': acumulado_fecha,
        })
    ...
    def _get_ledger_lines(self, move_line_ids, account_id):
        ...
        # delete count_parts to performance
