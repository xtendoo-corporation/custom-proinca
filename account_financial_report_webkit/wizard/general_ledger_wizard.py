...
class AccountReportGeneralLedgerWizard(orm.TransientModel):
    ...
    _columns = {
        ...
        'acumulado_fecha': fields.boolean("Acumulado en Fecha"),
    ...
    def check_report(self, cr, uid, ids, context=None):
        ...
        data['form'] = self.read(cr, uid, ids, ['date_from',  'date_to',  'fiscalyear_id', 'journal_ids', 'period_from', 'period_to',  'filter',  'chart_account_id', 'target_move', 'acumulado_fecha'], context=context)[0]
